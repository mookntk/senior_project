...
export default {
  data() {
    return {
      ...
      headers: [
        ...
        { text: "รายละเอียด", align: "center", value: "order" },
        { text: "สถานะ", align: "center", value: "order" }
      ],
      index: 0,
      order: [
        {
  ...
  methods: {
    getColor(status) {
      if (status == "ได้รับยาแล้ว") return "green";
      else if (status == "กำลังส่งยาคืน") return "orange";
    },
    showItem(item) {
