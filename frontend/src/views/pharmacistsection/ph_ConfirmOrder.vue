...
export default {
  ...
  methods: {
    changestatus() {
      if (this.order[this.index].status == "รอการตรวจสอบ") {
        this.order[this.index].status = "ตรวจสอบและยืนยันเรียบร้อย";
    ...
    getColor(status) {
      if (status == "รอการตรวจสอบ") return "orange";
      else if (status == "ตรวจสอบและยืนยันเรียบร้อย") return "green";
    },
    selectItem(item) {
  ...
  computed: {
    formtitle() {
      if (this.order[this.index].status == "รอการตรวจสอบ") {
        return "ตรวจสอบและยืนยันเรียบร้อย";
      } else if (this.order[this.index].status == "ตรวจสอบและยืนยันเรียบร้อย") {
        return "";
      }
    },
    date_th() {
