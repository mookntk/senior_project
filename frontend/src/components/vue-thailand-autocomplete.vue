      ...
      >
        ...
        >
          <div class="box-item-top">
            <span
              class="item-first"
              :class="{ 'box-item-top-focused': itemOnFocus === index && currentColor !== '#f5f5f5' }"
            >{{ itemFirst(item) }}</span>
            <div class="float-right">
              <span
                class="item-second"
                :class="{ 'box-item-top-focused': itemOnFocus === index && currentColor !== '#f5f5f5' }"
              >{{ itemSecond(item) }}</span>
              <span
                class="item-third"
                :class="{ 'box-item-top-focused': itemOnFocus === index && currentColor !== '#f5f5f5' }"
              >{{ itemThird(item) }}</span>
          ...
          <div class="box-item-bottom">
            <span
              class="item-first font-weight-bold"
              :style="{'color': itemOnFocus === index && currentColor !== '#f5f5f5' ? '#fff' : '#000'}"
            >{{ itemFourth(item) }}</span>
          </div>
        </div>
      </div>
    </div>
    ...
    resultsFromSearch() {
      if (this.type) {
        if (this.type === "district") return this.resultsFromSearchByDistrict;
          ...
          return this.resultsFromSearchByProvince;
        else if (this.type === "zipcode")
          return this.resultsFromSearchByZipcode;
      } else {
